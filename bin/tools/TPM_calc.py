...
parser.add_argument("-o", "--output", help = "output.txt, if not specified output will overwrite input", type = str, required = False)
parser.parse_args()
...
df.to_csv(args.input, sep = "\t", index = False, header = True)
